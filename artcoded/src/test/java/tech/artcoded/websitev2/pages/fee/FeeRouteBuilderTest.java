...
class FeeRouteBuilderTest extends CamelTestSupport {
    ...
    public void testNonAllowedEmail() throws Exception {
        ...
        mockEndpoint.expectedHeaderValuesReceivedInAnyOrder("From",
                List.of("noreply@example.com", "noreply2@example.com"));
    ...
    protected RoutesBuilder createRouteBuilder() {
        Mockito.when(feeService.save(anyString(), anyString(), Mockito.any(Date.class), Mockito.anyList()))
                .thenReturn(new Fee());
