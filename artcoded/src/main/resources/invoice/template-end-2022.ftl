<#setting locale="de">
  ...
  <body>
      <div class="d-flex flex-row justify-content-center">
        <img class="d-block opacity-25" src="${logo}">
    ...
    <div class="d-flex justify-content-between mb-3">
      <div>
        ...
        <p>${personalInfo.organizationAddress}, ${personalInfo.organizationPostCode} ${personalInfo.organizationCity}
        </p>
    ...
    <div class="d-flex justify-content-end mb-3">
      <h3>N°${invoice.invoiceNumber}</h3>
      <strong>Date of Invoice: ${invoice.dateOfInvoice?date?iso_utc}</strong>
    </div>
    ...
    <table class="table table-light table-borderless mb-3">
      ...
      <tbody class="table-group-divider">
        <#list invoice.invoiceTable as table>
          <tr>
            ...
            <td>
              <strong>${table.total}&euro;</strong>
            </td>
          </tr>
        </#list>
      </tbody>
      <tfoot>
        ...
        <tr>
          <td colspan="2"></td>
          <td colspan="2"><strong class="text-info">GRAND TOTAL</strong></td>
          <td><strong class="text-info">${invoice.total}&euro;</strong></td>
        </tr>
      </tfoot>
    </table>
