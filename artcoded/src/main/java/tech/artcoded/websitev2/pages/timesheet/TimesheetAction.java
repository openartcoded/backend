...
public class TimesheetAction implements Action {
                    ...
                    Stream.concat(timesheet.getPeriods().stream(),
                        localDates.stream()
                            ...
                            .map(date -> TimesheetPeriod.builder()
                                ...
                                .periodType(getPeriodTypeByDay(client, date))
                                .date(date).build()))
  ...
  public PeriodType getPeriodTypeByDay(BillableClient client, Date date) {
    ...
    return switch (dayOfWeek) {
      ...
      default ->
        client.getDefaultWorkingDays().contains(dayOfWeek) ? PeriodType.WORKING_DAY : PeriodType.AUTHORIZED_HOLIDAYS;
    };
  }
    ...
    return ActionMetadata.builder()
        ...
        .allowedParameters(List.of(
            ...
            ActionParameter.builder()
                ...
                .options(billableClientRepository.findAll().stream().map(c -> Map.entry(c.getId(), c.getName()))
