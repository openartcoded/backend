    ...
    public ReminderTask saveSync(ReminderTask reminderTask, boolean sendNotification) {
        ...
        ReminderTask.ReminderTaskBuilder reminderTaskBuilder = taskFromDb.toBuilder().title(reminderTask.getTitle())
                ...
                .disabled(reminderTask.isDisabled()
                        || (specificDate != null && reminderTask.getLastExecutionDate() != null) || nextDate == null)
                .persistResult(reminderTask.isPersistResult()).actionParameters(reminderTask.getActionParameters())
