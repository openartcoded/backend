...
public interface ModelConverter {
    ...
    static List<String> getLanguages() {
        return RDFLanguages.getRegisteredLanguages().stream().map(Lang::getName).collect(Collectors.toList());
    }

    static List<String> getAllowedLanguages() {
        return List.of("RDF/XML", "N-Triples", "TriX", "JSON-LD", "RDF-THRIFT", "Turtle", "N3", "N-Quads", "RDF/JSON",
                "TriG");
    }
