...
@Slf4j
@ChangeUnit(id = "default-template", order = "11", author = "Nordine Bittich")
public class CHANGE_LOG_11_DefaultTemplate {
    ...
    public void execute(InvoiceTemplateRepository templateRepository, FileUploadService fileUploadService)
        ...
        if (templateRepository.count() == 0) {
            ...
            InvoiceFreemarkerTemplate ift = InvoiceFreemarkerTemplate.builder().name("Template 2021").build();

            log.info("save default invoice template... ");
            MockMultipartFile templ = MockMultipartFile.builder().bytes(toByteArray(oldTemplate.getInputStream()))
