...
public class CHANGE_LOG_05_InitPersonalInfoChangeLog {
  ...
  public void execute(PersonalInfoService personalInfoService,
    ...
    repository.findAll().stream().findFirst().ifPresentOrElse(
        personalInfo -> log.info("Current personal info {}", personalInfo),
        () -> {
          personalInfoService.save(
              PersonalInfo.builder()
                  .ceoFullName("Bittich Nordine")
                  .note(
              ...
              MockMultipartFile.builder()
                  ...
                  .bytes(toSupplier(
                      () -> toByteArray(defaultLogo.getInputStream()))
                      .get())
              ...
              MockMultipartFile.builder()
                  ...
                  .bytes(
                      toSupplier(
                          () -> toByteArray(defaultSignature.getInputStream()))
                          .get())
              ...
              MockMultipartFile.builder()
                  ...
                  .bytes(
                      toSupplier(
                          () -> toByteArray(defaultInitials.getInputStream()))
                          .get())
                  .originalFilename("default-initials.png")
                  .build());
        });
  }
}
