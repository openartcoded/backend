    ...
    repository.findAll()
      ...
      .ifPresentOrElse(personalInfo -> log.info("Current personal info {}", personalInfo), () -> {
        personalInfoService.save(PersonalInfo.builder().ceoFullName("Bittich Nordine")
          .note("la facturation faite au client en vertu du contrat de consultance inclut une cession des droits d&#39;auteurs (droits patrimoniaux) sur &oelig;uvres, codes et programmes effectu&eacute;s par notre soci&eacute;t&eacute;, &agrave; charge pour notre entreprise de r&eacute;mun&eacute;rer ses auteurs.")
          ...
          .build(), MockMultipartFile.builder()
