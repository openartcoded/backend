...
public interface DateHelper {
    ...
    static String getCreationDateToString() {
        return ZonedDateTime.now(ZoneId.of("Europe/Paris")).format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss"));
    }
    ...
    static LocalDate toLocalDate(Date dateToConvert) {
        return dateToConvert.toInstant().atZone(ZoneId.of("Europe/Paris")).toLocalDate();
    }
