...
public class MongoManagementService {
    ...
    public MongoManagementService(Environment environment, MongoTemplate mongoTemplate, CacheManager cacheManager, NotificationService notificationService, Configuration configuration) {
